        ...
        <div className="grid gap-6 lg:grid-cols-[0.6fr_1fr]">
          <div className="space-y-3">
            {[
              ...
              <a
                ...
                className="flex items-center gap-3 rounded-xl border border-white/[0.07] bg-surface px-4 py-3.5 text-sm text-text-secondary transition-all hover:border-white/[0.14] hover:text-text-primary"
              >
          ...
          <form onSubmit={handleSubmit} className="rounded-2xl border border-white/[0.07] bg-surface p-6 md:p-7" aria-label="Contact form">
            <div className="grid gap-4">
              ...
              {validationError && (
                <div className="rounded-xl border border-accent/20 bg-accent/10 px-4 py-3 text-sm text-accent" role="alert">{validationError}</div>
              )}
